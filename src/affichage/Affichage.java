...
public class Affichage extends JPanel implements MouseListener, ActionListener {
	...
	protected void paintComponent(Graphics g)
	{
		...
		this.width = monImage.getWidth();
		this.height = monImage.getHeight();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(trueLandmark))
		{
			...
			Facade.addLandmark(this.file, (float)X, (float)Y, true);
		}
		else
		{
			Facade.addLandmark(this.file,(float)X, (float)Y, false);
